...
// closest to the pool exactly aligned with the pool wall. The previous 0.10m
// outward allowance left the spa 100mm too far away from the pool.
const SPA_OUTER_WALL_ALIGN_OFFSET = 0.0;
